window.TRANSLATIONS = {
  ...
  "about.intro": "Product and brand designer based in Lima. I like solving real problems: understanding people first and turning that into brands and products that feel clear, human and well thought out. I work between strategy and detail — where an idea becomes something people actually use.",
  ...
  "project.gastro-brand.s1.body":    "Gastro was a startup in formation with an initial logo, but no solid visual system. The challenge was to take that early foundation and build a more scalable, approachable and functional identity.",
  "project.gastro-brand.s2.heading": "Brand Strategy",
  "project.gastro-brand.s2.body":    "The strategic direction was to build a brand that could serve as a meeting point between the gastronomic experience and digital discovery. To achieve this, a close, trustworthy, innovative and transparent personality was defined — one that communicates clarity without losing warmth.",
  "project.gastro-brand.s3.heading": "Visual System",
  "project.gastro-brand.s3.body":    "The visual system was built around the symbol, a Poppins-based logotype with custom adjustments, a warm and contrasted palette, and a graphic language designed to feel clean and accessible. The orange brings energy and warmth, while white, linen and blue reinforce transparency, trust and solidity.<br><br>An identity built to scale with the brand and communicate confidence from the very first touchpoint.",
