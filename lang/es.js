window.TRANSLATIONS = {
  ...
  "project.gastro-brand.tagline":   "Convirtiendo una base inicial en una identidad escalable, cercana y funcional para una startup gastronómica.",
  "project.gastro-brand.s1.heading": "Contexto y Desafío",
  "project.gastro-brand.s1.body":    "Gastro era una startup en formación con un primer logotipo, pero sin un sistema visual sólido. El desafío fue convertir esa base inicial en una identidad más escalable, cercana y funcional.",
  "project.gastro-brand.s2.heading": "Estrategia de Marca",
  "project.gastro-brand.s2.body":    "La dirección estratégica fue construir una marca que funcionara como punto de encuentro entre la experiencia gastronómica y la búsqueda digital. Para ello, se definió una personalidad cercana, confiable, innovadora y transparente, capaz de comunicar claridad sin perder calidez.",
  "project.gastro-brand.s3.heading": "Sistema Visual",
  "project.gastro-brand.s3.body":    "El sistema visual se construyó a partir del símbolo, un logotipo basado en Poppins con ajustes personalizados, una paleta cálida y contrastada, y un lenguaje gráfico pensado para sentirse limpio y accesible. El color naranja aporta energía y calidez, mientras que el blanco, el lino y el azul refuerzan transparencia, confianza y solidez.<br><br>Una identidad diseñada para escalar con la marca y comunicar confianza desde el primer contacto.",
  ...
  "project.gastro-app.s1.body":     "Gastro nace desde cero: una app para que las personas en Costa Rica encuentren rápido dónde y qué comer cerca de ellas. El reto era resolverlo simple —buscar por tipo de cocina y ubicación, filtrar y decidir— sin convertirlo en una app cargada de funciones.",
  "project.gastro-app.s2.heading":  "Objetivos y alcance",
  "project.gastro-app.s2.body":     "A partir de entrevistas cualitativas definí dos perfiles de usuario, y sobre ellos un MVP enfocado: un flujo corto y claro para validar la propuesta. La prioridad fue la decisión rápida —encontrar y elegir restaurante— por encima de cualquier función secundaria.",
